      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            {/* Tagline Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-100/80 border border-orange-200 text-michi-800 text-xs sm:text-sm font-bold shadow-xs">
              <span className="w-2 h-2 rounded-full bg-michi-500 animate-pulse" />
              <span>Cuidando los felinos del Parque Universitario y Lima</span>
              <span className="bg-amber-300/60 text-amber-900 text-[10px] font-black px-1.5 py-0.5 rounded-md uppercase">
                Perú
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
              <a
                href="#adopciones"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-michi-500 via-orange-500 to-red-500 hover:from-michi-600 hover:to-red-600 shadow-warm hover:shadow-warm-lg transition-all transform hover:-translate-y-0.5"
              >
              ...
              <a
                href="#bingo-eventos"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-base font-bold text-michi-800 bg-orange-50 hover:bg-orange-100 border border-orange-200 transition-all transform hover:-translate-y-0.5"
              >
                <Sparkles className="w-5 h-5 text-michi-600" />
                <span>Michi Bingo Solidario</span>
              </a>

              <a
                href="#donaciones"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-2xl text-base font-bold text-stone-700 bg-white hover:bg-stone-50 border border-stone-200 transition-all shadow-xs"
              >
            ...
            {/* Quick Guarantees */}
            <div className="pt-4 border-t border-orange-100/80 grid grid-cols-2 sm:grid-cols-3 gap-3 text-left">
              ...
              <div className="flex items-center gap-2 text-xs font-semibold text-stone-600 col-span-2 sm:col-span-1">
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-amber-50 group">
                ...
                <div className="absolute bottom-0 inset-x-0 p-6 text-white">
                  ...
                  <a
                    href="#adopciones"
                    className="mt-3 inline-flex items-center gap-1.5 text-xs font-bold text-amber-300 hover:text-white transition-colors"
                  >
        ...
        <div className="mt-16 pt-8 border-t border-orange-200/60 grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
          <div className="bg-white/70 backdrop-blur-xs p-5 rounded-2xl border border-orange-100 shadow-xs text-center">
            <span className="block text-3xl sm:text-4xl font-black text-michi-600 font-display">
              +1,850
            </span>
            <span className="text-xs sm:text-sm font-semibold text-stone-600 mt-1 block">
              Esterilizaciones TNR realizadas
            </span>
          </div>

          <div className="bg-white/70 backdrop-blur-xs p-5 rounded-2xl border border-orange-100 shadow-xs text-center">
            <span className="block text-3xl sm:text-4xl font-black text-amber-600 font-display">
              +980
            </span>
            <span className="text-xs sm:text-sm font-semibold text-stone-600 mt-1 block">
          ...
          <div className="bg-white/70 backdrop-blur-xs p-5 rounded-2xl border border-orange-100 shadow-xs text-center">
            <span className="block text-3xl sm:text-4xl font-black text-red-500 font-display">
              100%
            </span>
            <span className="text-xs sm:text-sm font-semibold text-stone-600 mt-1 block">
          ...
          <div className="bg-white/70 backdrop-blur-xs p-5 rounded-2xl border border-orange-100 shadow-xs text-center">
            <span className="block text-3xl sm:text-4xl font-black text-emerald-600 font-display">
              12 Años
            </span>
            <span className="text-xs sm:text-sm font-semibold text-stone-600 mt-1 block">
