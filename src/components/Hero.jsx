      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            {/* Tagline Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-bone border border-brand-peach text-stone-700 text-xs sm:text-sm font-bold shadow-xs">
              <span className="w-2 h-2 rounded-full bg-brand-orange animate-pulse" />
              <span>Cuidando los felinos del Parque Universitario y Lima</span>
              <span className="bg-brand-vanilla text-brand-orange text-[10px] font-black px-1.5 py-0.5 rounded-md uppercase border border-brand-peach/50">
                Perú
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-stone-900 tracking-tight leading-[1.1] font-display">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
              <a
                href="#adopciones"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-brand-orange to-michi-600 hover:from-michi-600 hover:to-amber-500 shadow-warm hover:shadow-warm-lg transition-all transform hover:-translate-y-0.5"
              >
              ...
              <a
                href="#bingo-eventos"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-base font-bold text-stone-800 bg-brand-bone hover:bg-brand-peach/40 border border-brand-peach transition-all transform hover:-translate-y-0.5"
              >
              ...
              <a
                href="#donaciones"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-2xl text-base font-bold text-stone-800 bg-brand-marfil hover:bg-brand-bone border border-brand-peach transition-all shadow-xs"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -top-4 left-2 sm:-top-5 sm:-left-6 bg-brand-marfil rounded-2xl p-2.5 sm:p-3.5 shadow-xl border border-brand-peach flex items-center gap-2.5 sm:gap-3 animate-soft-pulse z-10">
                <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-tr from-brand-orange to-amber-500 flex items-center justify-center text-white shadow-md shrink-0">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-stone-900">Michi Bingo Solidario</p>
              ...
              <div className="absolute -bottom-4 right-2 sm:-bottom-5 sm:-right-6 bg-brand-marfil rounded-2xl p-2.5 sm:p-3.5 shadow-xl border border-brand-peach flex items-center gap-2.5 sm:gap-3 z-10">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-stone-900">Cartilla al día</p>
        ...
        <div className="mt-16 pt-8 border-t border-brand-peach/60 grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="bg-brand-marfil/90 backdrop-blur-xs p-5 rounded-2xl border border-brand-peach/70 shadow-xs text-center">
            <span className="block text-3xl sm:text-4xl font-black text-stone-800 font-display">
              +980
            </span>
            <span className="text-xs sm:text-sm font-semibold text-stone-600 mt-1 block">
