          ...
          <div className="absolute bottom-4 left-6 right-6 flex items-end justify-between">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="bg-brand-vanilla text-stone-900 border border-brand-peach text-xs font-black px-2.5 py-0.5 rounded-full uppercase">
                  {cat.gender} • {cat.age}
                </span>
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto">
          {activeTab === 'bio' ? (
            <div className="space-y-6">
              ...
              {cat.observations && (
                <div className="bg-brand-bone border-l-4 border-brand-orange p-3 rounded-r-xl text-xs text-stone-800 font-medium">
                  <strong className="text-stone-700">Observaciones del refugio:</strong> {cat.observations}
                </div>
              )}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {cat.personality.map((trait, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 rounded-full text-xs font-bold bg-brand-vanilla text-stone-800 border border-brand-peach/80"
                    >
                      ✨ {trait}
                    </span>
                  ))}
              ...
              {/* Special Note */}
              {cat.specialNote && (
                <div className="bg-brand-bone border-l-4 border-brand-peach p-3.5 rounded-r-xl text-xs text-stone-800">
                  <strong className="text-stone-700">Recomendación Misicha:</strong> {cat.specialNote}
                </div>
              )}
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-stone-800 bg-brand-bone hover:bg-brand-peach/30 border border-brand-peach/60 font-bold text-sm transition-all"
                >
              ...
              {submitted ? (
                <div className="text-center py-8 space-y-4">
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <button
                      onClick={onClose}
                      className="px-5 py-3 rounded-xl bg-brand-bone hover:bg-brand-peach/30 border border-brand-peach/60 text-stone-800 font-bold text-sm"
                    >
                      Cerrar ventana
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl border border-brand-peach/60 focus:outline-none focus:ring-2 focus:ring-brand-orange bg-[#FFFCF7] text-stone-900 text-sm"
                      />
                    </div>
